...
        const shapeA = new Rectangle(pointA.shape.left, pointA.shape.top, pointA.shape.width, pointA.shape.height);
        const shapeB = new Rectangle(pointB.shape.left, pointB.shape.top, pointB.shape.width, pointB.shape.height);
        const bigBounds = new Rectangle(opts.globalBounds.left, opts.globalBounds.top, opts.globalBounds.width, opts.globalBounds.height);
